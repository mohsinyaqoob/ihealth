...
const ReportVitalsForm = (props) => {
  ...
  const handleSubmit = e => {
    ...
    axios.post('/api/doctor/treatment/vitals', body, config)
      .then(res => {
        toast(res.data.msg, { type: 'success' })
        setFormData({})
        props.history.push(`/doctor/dashboard/continueTreatment/${formData.checkin}`)
      })
      .catch(err => {
    ...
    <div className="content-wrapper">
      ...
      <section className="content">
        ...
        <div className="col-md-12">
          <RecentVitals checkinId={props.match.params.checkinId} showTotal={30} />
        </div>
      </section>
    </div>
  )
...
export default ReportVitalsForm
