...
const Aside = ({ loading, agent }) => {
  return (
    <aside className="main-sidebar sidebar-dark-primary elevation-4">
      {/* Brand Logo */}
      <Link to="/agent/dashboard" className="brand-link">
      ...
      <div className="sidebar">
        ...
        <div className="pb-3 mt-3 mb-3 user-panel d-flex">
          ...
          <div className="info">
            <Link to="/agent/dashboard" className="d-block">
        ...
        <nav className="mt-2">
         ...
         with font-awesome or any other icon font library */}
            ...
            <li className="nav-header text-bold text-primary">IN-PATIENT <span className="text-danger">(IPD)</span>
            </li>
            <li className="nav-item">
              <Link to="/agent/dashboard/quickCare" className="nav-link">
            ...
            <li className="nav-item">
              <Link to="/agent/dashboard/admission" className="nav-link">
            ...
            <li className="nav-item">
              <Link to="/agent/dashboard/discharge" className="nav-link">
            ...
            <li className="nav-item">
              <Link to="/agent/dashboard/consultation" className="nav-link">
            ...
            <li className="nav-header text-bold">CHECK-INS</li>
            <li className="nav-item">
              <Link to="/agent/dashboard/checkins" className="nav-link">
