...
import PatientDash from '../../../../assets/img/patient-dashboard.jpg'
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="p-0 card">
                <div className="p-0 rounded card-body">
                  <img src={PatientDash} alt="Patient Dashboard" className="img-fluid img-responsive" />
                </div>
              </div>
            </div>
          </div>
