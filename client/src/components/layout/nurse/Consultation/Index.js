...
const Index = () => {
  ...
  useEffect(() => {
    ...
    axios.get('/api/nurse/data/checkins?checkInType=consultation')
      .then(res => {
          ...
          <div className="mb-2 row">
            ...
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                ...
                <li className="breadcrumb-item">Consultation</li>
              </ol>
            </div>{/* /.col */}
          </div>{/* /.row */}
        </div>{/* /.container-fluid */}
              ...
              <div className="card">
                <div className="card-header">
                  <h1 className="card-title">
                    Consultation <span className="p-1 badge badge-danger">OPD</span>
                  </h1>
