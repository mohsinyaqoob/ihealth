      ...
      try {
        const res = await axios.post(`/api/lab/data/uploadLabReport?testId=${testId}`, formData, {
          ...
          onUploadProgress: progressEvent => {
            ...
            setTimeout(() => {
              setUploadProgress(0)
              props.history.push(`/lab/dashboard/revealAssignedLabTests/${patientId}`)
            }, 3000)
          }
        })
        ...
        <div className="container-fluid">
          <div className="mb-2 row">
            <div className="col-sm-6">
              <h1 className="m-0">Upload Lab Report</h1>
            </div>{/* /.col */}
            <div className="col-sm-6">
                ...
                <div className="card card-primary">
                  <div className="card-header">
                    ...
                    <div className="card-tools">
                      <Link to={`/lab/dashboard/revealAssignedLabTests/${patientId}`} className="m-0 bg-white btn btn-sm">Go Back</Link>
                    </div>
                  </div>
